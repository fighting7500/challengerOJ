...
1. 什么是 AJAX ? [mdn](https://developer.mozilla.org/zh-CN/docs/Web/Guide/AJAX/Getting_Started)
   ...
   * 浏览器网页中，使用 AJAX技术（XHR对象）发起获取省份列表数据的请求，服务器代码响应准备好的省份列表数据给前端，前端拿到数据数组以后，展示到网页
     ...
     ![image-20230403173156484](D:\Desktop\笔记\images\image-20230403173156484.png)
...
5. 需求：从服务器获取省份列表数据，展示到页面上（体验 axios 语法的使用）
   ...
   * 完成效果：
     ...
     ![image-20230220113157010](D:\Desktop\笔记\images\image-20230220113157010.png)
...
2. 什么是 URL ？
   ...
   * 统一资源定位符，简称网址，用于定位网络中的资源（资源指的是：网页，图片，数据，视频，音频等等）
     ...
     ![image-20230403185206384](D:\Desktop\笔记\images\image-20230403185206384.png)

3. URL 的组成?

   * 协议，域名，资源路径（URL 组成有很多部分，我们先掌握这3个重要的部分即可）

     ![image-20230403185305934](D:\Desktop\笔记\images\image-20230403185305934.png)
...
4. 什么是 http 协议 ?
   ...
   * 叫超文本传输协议，规定了浏览器和服务器传递数据的格式（而格式具体有哪些稍后我们就会学到）
     ...
     ![image-20230403185356997](D:\Desktop\笔记\images\image-20230403185356997.png)

5. 什么是域名 ?

   * 标记服务器在互联网当中的方位，网络中有很多服务器，你想访问哪一台，就需要知道它的域名才可以

     ![image-20230403185406674](D:\Desktop\笔记\images\image-20230403185406674.png)

6. 什么是资源路径 ?

   * 一个服务器内有多个资源，用于标识你要访问的资源具体的位置

     ![image-20230403185428276](D:\Desktop\笔记\images\image-20230403185428276.png)

7. 接下来做个需求，访问新闻列表的 URL 网址，打印新闻数据

   * 效果图如下：

   ![image-20230220122455915](D:\Desktop\笔记\images\image-202302201224559十五、png)
...
1. 什么是查询参数 ?
   ...
   * 举例：查询河北省下属的城市列表，需要先把河北省传递给服务器
     ...
     ![image-20230404101257205](D:\Desktop\笔记\images\image-20230404101257205.png)
...
1. 需求：根据输入的省份名字和城市名字，查询下属地区列表
   ...
   * 完成效果如下：
     ...
     ![image-20230220125428695](D:\Desktop\笔记\images\image-20230220125428695.png)
...
1. 想要提交数据，先来了解什么是请求方法
   ...
   * 请求方法是一些固定单词的英文，例如：GET，POST，PUT，DELETE，PATCH（这些都是http协议规定的），每个单词对应一种对服务器资源要执行的操作
     ...
     ![image-20230220130833363](D:\Desktop\笔记\images\image-20230220130833363.png)

     ![image-20230404104319428](D:\Desktop\笔记\images\image-20230404104319428.png)
...
2. 什么时候进行数据提交呢？
   ...
   * 例如：多端要查看同一份订单数据，或者使用同一个账号进行登录，那订单/用户名+密码，就需要保存在服务器上，随时随地进行访问
     ...
     ![image-20230404104328384](D:\Desktop\笔记\images\image-20230404104328384.png)

     ![image-20230404104333584](D:\Desktop\笔记\images\image-20230404104333584.png)
...
4. 需求：注册账号，提交用户名和密码到服务器保存
   ...
   ![image-20230404104350387](D:\Desktop\笔记\images\image-20230404104350387.png)
...
1. 如果注册相同的用户名，则会遇到注册失败的请求，也就是 axios 请求响应失败了，你会在控制台看到如图的错误：
   ...
   ![image-20230220131753051](D:\Desktop\笔记\images\image-20230220131753051.png)
...
4. 需求：再次重复注册相同用户名，提示用户注册失败的原因
   ...
   ![image-20230404104440224](D:\Desktop\笔记\images\image-20230404104440224.png)

   ![image-20230404104447501](D:\Desktop\笔记\images\image-20230404104447501.png)
...
2. 请求报文：是浏览器按照协议规定发送给服务器的内容，例如刚刚注册用户时，发起的请求报文：
   ...
   ![image-20230404104508764](D:\Desktop\笔记\images\image-20230404104508764.png)

   ![image-20230220132229960](D:\Desktop\笔记\images\image-20230220132229960.png)
...
3. 通过 Chrome 的网络面板如何查看请求体？
   ...
   ![image-20230220132617016](D:\Desktop\笔记\images\image-20230220132617016.png)
...
1. 响应报文：是服务器按照协议固定的格式，返回给浏览器的内容
   ...
   ![image-20230404104556531](D:\Desktop\笔记\images\image-20230404104556531.png)

   ![image-20230220133141151](D:\Desktop\笔记\images\image-20230220133141151.png)
...
3. HTTP 响应状态码：
   ...
   * 例如：404（客户端要找的资源，在服务器上不存在）
     ...
     ![image-20230220133344116](D:\Desktop\笔记\images\image-20230220133344116.png)
...
3. 例如：获取城市列表接口样子
   ...
   ![image-20230404104720587](D:\Desktop\笔记\images\image-20230404104720587.png)
...
3. 分析实现的步骤
   ...
   3. 提示信息，反馈给用户（这节课先来完成前 2 个步骤）
      ...
      ![image-20230404104851497](D:\Desktop\笔记\images\image-20230404104851497.png)
...
1. 需求：使用提前准备好的提示框，来把登录成功/失败结果提示给用户
   ...
   ![image-20230404104955330](D:\Desktop\笔记\images\image-20230404104955330.png)

   ![image-20230404105003019](D:\Desktop\笔记\images\image-20230404105003019.png)
...
1. 我们前面收集表单元素的值，是一个个标签获取的
   ...
   ![image-20230404105134538](D:\Desktop\笔记\images\image-20230404105134538.png)

2. 如果一套表单里有很多很多表单元素，如何一次性快速收集出来呢？

   ![image-20230404105141226](D:\Desktop\笔记\images\image-20230404105141226.png)
...
1. 打开备课代码运行图书管理案例效果-介绍要完成的增删改查业务效果和 Bootstrap 弹框使用
   ...
   ![image-20230404105414757](D:\Desktop\笔记\images\image-20230404105414757-1690267852848-2.png)

   ![image-20230404105421707](D:\Desktop\笔记\images\image-20230404105421707-1690267852848-1.png)
...
1. 什么是 Bootstrap 弹框？
   ...
   * 不离开当前页面，显示单独内容，供用户操作
     ...
     ![image-20230404105801739](D:\Desktop\笔记\images\image-20230404105801739-1690267852848-5.png)

2. 需求：使用 Bootstrap 弹框，先做个简单效果，点击按钮，让弹框出现，点击 X 和 Close 让弹框隐藏

   ![image-20230404105858660](D:\Desktop\笔记\images\image-20230404105858660-1690267852848-3.png)
...
1. 为什么需要 JS 方式控制呢？
   ...
   * 例如：
     ...
     * 点击保存按钮，在弹框隐藏之前，获取用户填入的名字并打印
     ...
     ![image-20230404110038828](D:\Desktop\笔记\images\image-20230404110038828-1690267852848-4.png)
...
1. 需求：基于 axios 获取到图书列表数据，并用 JS 代码渲染数据，到准备好的模板标签中
   ...
   ![image-20230404110943200](D:\Desktop\笔记\images\image-20230404110943200-1690267852848-6.png)
...
2. 步骤：
   ...
   2. 渲染数据
      ...
      ![image-20230404110953752](D:\Desktop\笔记\images\image-20230404110953752-1690267852848-7.png)

      ![image-20230404111014560](D:\Desktop\笔记\images\image-20230404111014560-1690267852848-8.png)
...
1. 需求：点击添加按钮，出现准备好的新增图书弹框，填写图书信息提交到服务器保存，并更新图书列表
   ...
   ![image-20230404111235862](D:\Desktop\笔记\images\image-20230404111235862-1690267852848-9.png)

   ![image-20230404111251254](D:\Desktop\笔记\images\image-20230404111251254-1690267852848-10.png)
...
2. 步骤：
   ...
   3. 刷新-图书列表）（重新调用下之前封装的获取并渲染列表的函数）
      ...
      ![image-20230404111343653](D:\Desktop\笔记\images\image-20230404111343653-1690267852848-11.png)
...
1. 需求：点击图书删除元素，删除当前图书数据
   ...
   ![image-20230404111530311](D:\Desktop\笔记\images\image-20230404111530311-1690267852848-12.png)

   ![image-20230404111546639](D:\Desktop\笔记\images\image-20230404111546639-1690267852848-13.png)
...
2. 步骤：
   ...
   3. 重新获取并刷新图书列表
      ...
      ![image-20230404111612125](D:\Desktop\笔记\images\image-20230404111612125-1690267852848-14.png)
...
2. 需求：完成编辑图书回显当前图书数据到编辑表单，在用户点击修改按钮，收集数据提交到服务器保存，并刷新列表
   ...
   ![image-20230404111722254](D:\Desktop\笔记\images\image-20230404111722254-1690267852848-15.png)
...
3. 编辑数据的核心思路：
   ...
   2. 基于 axios 和接口文档，调用查询图书详情接口，获取正在编辑的图书数据，并回显到表单中（页面上的数据是在用户的浏览器中不够准备，所以只要是查看数据都要从服务器获取）
      ...
      ![image-20230404111739153](D:\Desktop\笔记\images\image-20230404111739153-1690267852848-16.png)

   3. 收集并提交保存修改数据，并重新从服务器获取列表刷新页面

      ![image-20230404111756655](D:\Desktop\笔记\images\image-20230404111756655-1690267852848-17.png)
...
1. 因为增删改查的业务在前端实际开发中非常常见，思路是可以通用的，所以总结下思路
   ...
   ![image-20230404111941722](D:\Desktop\笔记\images\image-20230404111941722-1690267852848-18.png)
...
3. 新增数据（增）
   ...
   ![image-20230404112942935](D:\Desktop\笔记\images\image-20230404112942935-1690267852849-19.png)
...
4. 删除图书（删）
   ...
   ![image-20230404113338815](D:\Desktop\笔记\images\image-20230404113338815-1690267852849-20.png)
...
5. 编辑图书（改）
   ...
   ![image-20230404113702515](D:\Desktop\笔记\images\image-20230404113702515-1690267852849-21.png)
...
1. 需求：先运行备课代码，查看要完成的效果，点击右上角选择本机中提供的素材图片，更换网站背景图
   ...
   ![image-20230404122349505](D:\Desktop\笔记\images\image-20230404122349505-1690267852849-22.png)
...
1. 需求：先运行备课代码，查看要完成的效果
   ...
   ![image-20230404123206073](D:\Desktop\笔记\images\image-20230404123206073-1690267852849-23.png)
...
1. 需求：把外号对应的个人信息和头像，渲染到页面表单和头像标签上。
   ...
   ![image-20230404123708765](D:\Desktop\笔记\images\image-20230404123708765-1690267852849-24.png)
...
1. 需求：点击修改用户头像
   ...
   ![image-20230404124524401](D:\Desktop\笔记\images\image-20230404124524401-1690267852849-25.png)
...
2. 实现步骤如下：
   ...
   3. 提交到服务器保存此用户对应头像文件，并把返回的头像图片 url 网址设置在页面上
      ...
      ![image-20230404124540629](D:\Desktop\笔记\images\image-20230404124540629-1690267852849-26.png)
...
1. 需求：点击提交按钮，收集个人信息，提交到服务器保存（无需重新获取刷新，因为页面已经是最新的数据了）
   ...
   2. 提交到服务器保存-调用用户信息更新接口（注意请求方法是 PUT）代表数据更新的意思
      ...
      ![image-20230404125310049](D:\Desktop\笔记\images\image-20230404125310049-1690267852849-27.png)
...
1. 需求：使用 bootstrap 提示框，提示个人信息设置后的结果
   ...
   ![image-20230404125517679](D:\Desktop\笔记\images\image-20230404125517679-1690267852849-28.png)
...
3. 学习 XHR 也是了解 axios 内部与服务器交互过程的真正原理
   ...
   ![image-20230221182835545](D:\Desktop\笔记\images\image-20230221182835545-1690469468081-14.png)
...
4. 语法如下：
   ...
   ![image-20230221183057392](D:\Desktop\笔记\images\image-20230221183057392-1690469468081-15.png)
...
4. 需求：查询河北省下属的城市列表
   ...
   ![image-20230404133429378](D:\Desktop\笔记\images\image-20230404133429378-1690469468081-16.png)
...
1. 需求：和我们之前做的类似，就是不用 axios 而是用 XHR 实现，输入省份和城市名字后，点击查询，传递多对查询参数并获取地区列表的需求
   ...
   ![image-20230221184135458](D:\Desktop\笔记\images\image-20230221184135458-1690469468081-18.png)
...
2. 需求：通过 XHR 完成注册用户功能
   ...
   ![image-20230404135245271](D:\Desktop\笔记\images\image-20230404135245271-1690469468081-17.png)
...
2. Promise 的好处是什么？
   ...
   * 了解 axios 函数内部运作的机制
     ...
     ![image-20230222113651404](D:\Desktop\笔记\images\image-20230222113651404-1690469468081-19.png)
...
3. Promise 的状态改变有什么用：调用对应函数，改变 Promise 对象状态后，内部触发对应回调函数传参并执行
   ...
   ![image-20230222120815484](D:\Desktop\笔记\images\image-20230222120815484-1690469468081-21.png)
...
2. 需求：使用 Promise 和 XHR 请求省份列表数据并展示到页面上
   ...
   ![image-20230404140252181](D:\Desktop\笔记\images\image-20230404140252181-1690469468081-20.png)
...
1. 需求：基于 Promise 和 XHR 封装 myAxios 函数，获取省份列表展示到页面
   ...
   ![image-20230222130217597](D:\Desktop\笔记\images\image-20230222130217597-1690469468081-22.png)
...
1. 需求：介绍本项目要完成的效果，和要实现的步骤和分的步骤和视频
   ...
   ![image-20230222133327806](D:\Desktop\笔记\images\image-20230222133327806-1690469468082-23.png)
...
1. 介绍本视频要完成的效果：搜索匹配关键字相关城市名字，展示城市列表即可
   ...
   ![image-20230222133553010](D:\Desktop\笔记\images\image-20230222133553010-1690469468082-24.png)
...
1. 介绍本视频要完成的效果：点击城市列表名字，切换当前页面天气数据
   ...
   ![image-20230222134653884](D:\Desktop\笔记\images\image-20230222134653884-1690469468082-25.png)
...
1. 需求：展示默认第一个省，第一个城市，第一个地区在下拉菜单中
   ...
   ![image-20230222173109762](D:\Desktop\笔记\images\image-20230222173109762.png)
...
3. 好处：通过链式调用，解决回调函数嵌套问题
   ...
   ![image-20230222173851738](D:\Desktop\笔记\images\image-20230222173851738.png)
...
2. 做法：每个 Promise 对象中管理一个异步任务，用 then 返回 Promise 对象，串联起来
   ...
   <img src="D:\Desktop\笔记\images\image-20230222174946534.png" alt="image-20230222174946534" style="zoom: 200%;" />
...
4. 概念：执行代码和收集异步任务的模型，在调用栈空闲，反复调用任务队列里回调函数的执行机制，就叫事件循环
   ...
   */
   ...
   ![image-20230222182338992](D:\Desktop\笔记\images\image-20230222182338992.png)
...
1. 需求：请根据掌握的事件循环的模型概念，分析代码执行过程
   ...
   */
   ...
   ![image-20230222183656761](D:\Desktop\笔记\images\image-20230222183656761.png)
...
3. 宏任务和微任务具体划分：
   ...
   ![image-20230222184920343](D:\Desktop\笔记\images\image-20230222184920343.png)
...
4. 事件循环模型
   ...
   */
   ...
   ![image-20230222184949605](D:\Desktop\笔记\images\image-20230222184949605.png)
...
![image-20230222185205193](D:\Desktop\笔记\images\image-20230222185205193.png)
...
1. 需求：请切换到对应配套代码，查看具体代码，并回答打印顺序（锻炼事件循环概念的理解，阅读代码执行顺序_）
   ...
   ![image-20230222185939276](D:\Desktop\笔记\images\image-20230222185939276.png)
...
1. 概念：合并多个 Promise 对象，等待所有同时成功完成（或某一个失败），做后续逻辑
   ...
   ![image-20230222190117045](D:\Desktop\笔记\images\image-20230222190117045.png)
...
3. 需求：同时请求“北京”，“上海”，“广州”，“深圳”的天气并在网页尽可能同时显示
   ...
   ![image-20230222190230351](D:\Desktop\笔记\images\image-20230222190230351.png)
...
1. 需求：尽可能同时展示所有商品分类到页面上
   ...
   ![image-20230222191151264](D:\Desktop\笔记\images\image-20230222191151264.png)
...
1. 需求：完成省市区切换效果
   ...
   ![image-20230222191239971](D:\Desktop\笔记\images\image-20230222191239971.png)
