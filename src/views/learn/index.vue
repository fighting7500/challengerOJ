...
<template>
                ...
                <div class="moduleContainer">
                    <div class="module" v-for="(item, i) in tabContentList[index].slice(0, count[index])" :key="i" @click="() => getDetail(item)">
                        <div class="moduleContent">
                            <div class="img">
                                <a-image style="width: 100%; height: 100%; border-radius: 8px" src="https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg" fit="fill" />
                            </div>
    ...
    <a-back-top :right="80" :bottom="100" />
</template>
