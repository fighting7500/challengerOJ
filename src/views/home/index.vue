        ...
        <div class="container">
            <div class="row row-grid align-items-center">
                <div class="col-12 col-md-5 col-lg-6 order-md-2 text-center">
                    <figure class="w-100">
                        <img alt="Image placeholder" src="@/assets/illustration-3.svg" class="img-fluid mw-md-120" />
                    </figure>
                </div>
                <div class="col-12 col-md-7 col-lg-6 order-md-1 pr-md-5">
                    <!-- Heading -->
                    <h1 class="display-4 text-center text-md-left mb-3">面向编程爱好者和专业人士的<strong class="text-primary">在线编程挑战平台</strong></h1>
                    <!-- Text -->
                    <p class="lead text-center text-md-left text-muted">开始你的编程之旅！</p>
                    <!-- Buttons -->
                    <div class="text-center text-md-left mt-5">
                        ...
                        <a href="https://webpixels.io/illustrations" class="btn btn-neutral btn-icon d-none d-lg-inline-block" target="_blank">学习课程</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row mt-5">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body pb-5">
                            <div class="pt-4 pb-5">
                                <img src="@/assets/illustration-5.svg" class="img-fluid img-center" style="height: 150px" alt="Illustration" />
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body pb-5">
                            <div class="pt-4 pb-5">
                                <img src="@/assets/illustration-6.svg" class="img-fluid img-center" style="height: 150px" alt="Illustration" />
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body pb-5">
                            <div class="pt-4 pb-5">
                                <img src="@/assets/illustration-7.svg" class="img-fluid img-center" style="height: 150px" alt="Illustration" />
                            </div>
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="card mb-0 mr-lg-5">
                            <div class="card-body p-2">
                                <img alt="Image placeholder" src="@/assets/screen-1-1000x800.jpg" class="img-fluid shadow rounded" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row row-grid justify-content-between align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="card mb-0 ml-lg-5">
                            <div class="card-body p-2">
                                <img alt="Image placeholder" src="@/assets/screen-2-1000x800.jpg" class="img-fluid shadow rounded" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="row justify-content-center">
                    <div class="col-md-10 text-center">
                        <div class="mt-4 mb-6">
                            <h2 class="h1 text-white">Are you ready to grow faster?</h2>
                    ...
                    <div class="card">
                        <div class="d-flex p-5">
                            ...
                            <div class="pl-4">
                                ...
                                <p class="text-muted mb-0">Design made simple with a clean and smart HTML markup.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="slice slice-lg bg-section-secondary">
        <div class="container text-center">
            <div class="row justify-content-center mb-6">
                <div class="col-lg-8">
                    <!-- Title -->
                    <h2 class="h1 strong-600">Complete features at your hand</h2>
                    <!-- Text -->
                    <p class="text-muted">Thousands of developers around the world have already made Quick the main tool for building websites.</p>
                </div>
            </div>
            <!-- Pricing -->
            <div class="row justify-content-center">
